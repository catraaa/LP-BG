      ...
      <div className="relative flex flex-col lg:flex-row bg-white-500 shadow-md rounded-3xl overflow-hidden group transition-all duration-500 hover:bg-blue-500">
        ...
        <div className="w-full lg:w-1/2 p-6 lg:p-10 flex flex-col justify-center z-20">
          ...
          <p className="text-sm lg:text-base mb-6 text-black group-hover:text-white-500 transition-colors duration-300">
            Bagong Pariwisata menyediakan transportasi sewa berupa bus pariwisata Big Bus, Medium Canter Bus, Medium Long Bus, Jumbo dan Hiace Premio dengan body AVANTE H7, AVANTE H8, Legacy SR2, Legacy SR3, Jetbus 5 MHD, Jetbus 5 SHD, Navigator dan sasis HINO RK280, HINO RM280, HINO RN285, MERCEDES BENZ OH 1626, MERCEDES BENZ OF 917, MITSUBSHI CANTER EURO 4, MITSUBSHI CANTER EURO 2. Kami melayani overland Jawa–Bali, Luar Pulau, Ziarah Wali, MICE, Study Tour, dan City Tour.
          </p>
